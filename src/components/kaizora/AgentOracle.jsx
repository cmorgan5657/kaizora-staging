      ...
      <div className="mx-auto max-w-[1400px]">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <motion.h2
            ...
            className="font-display font-bold text-4xl sm:text-5xl lg:text-6xl tracking-[-0.03em] text-white max-w-3xl"
          >
            Top-tier agents that <span className="text-gradient-cyan">coach every creation</span>
          </motion.h2>
          <p className="mt-5 text-zinc-400 max-w-xl">Editorial profiles of the intelligence layer — each one evaluates, guides, and elevates.</p>
        </div>
            ...
            >
              <div className="relative rounded-3xl overflow-hidden glass aspect-[3/4]">
                ...
                <div className="absolute bottom-0 inset-x-0 p-6">
                  <p className="text-[10px] tracking-[0.3em] uppercase text-zinc-400">{agent.role}</p>
